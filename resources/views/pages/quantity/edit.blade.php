          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Form Edit Quantity</h3>
                  </div>
                  <form action="{{ route('quantity.update', $item->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-body">
                      <div class="form-group">
                        <label for="name">Nama  <span class="text-danger">*</span></label>
                        <input type="text" value="{{ old('name') ?? $item->name }}" class="form-control" id="name" name="name" placeholder="Enter Nama " required>
                      </div>
                      <div class="form-group">
